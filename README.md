...
Closure def - makes a func remember all vars that existed at time of original func birthplace | any func always has access to var environment of execution context where it was created (even when its gone - attatched to func) |
